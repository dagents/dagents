    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                optional: true,
                // MZW-259 (M3.3): default ON so agentflows recover cross-turn state via the
                // shared PG `execution` table without every flow author remembering to set it.
                // Gate-2 §4.1 — config-level change, not an architecture refactor.
                default: true
            }
        ]
    }
